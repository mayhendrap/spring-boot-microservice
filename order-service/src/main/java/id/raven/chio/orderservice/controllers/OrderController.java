package id.raven.chio.orderservice.controllers;

import id.raven.chio.orderservice.dtos.request.OrderRequest;
import id.raven.chio.orderservice.services.OrderService;
...
public class OrderController {
  ...
  public CompletableFuture<String> fallbackMethod(OrderRequest orderRequest,
    ...
    return CompletableFuture.supplyAsync(
        () -> "Ups! Something went wrong, please order after some time");
  }
